...
REPO = ENV.fetch("GITHUB_REPOSITORY", "jaxassistant55/subscription-audit-savings-starter")
OFFER_TITLE = "Subscription Audit Savings Starter"
PRICE = "$100"
OFFER_PAGE = "https://jaxassistant55.github.io/subscription-audit-savings-starter/"
READY_FORM = "https://github.com/jaxassistant55/subscription-audit-savings-starter/issues/new?template=ready-to-pay-subscription-audit-savings-starter.yml"
ORDER_BOARD = "https://github.com/jaxassistant55/subscription-audit-savings-starter/issues/1"
...
ONE_SALE_PAYMENT_PACKET = "https://jaxassistant55.github.io/jax-micro-offer-studio/one-sale-payment-packets.html#standalone-subscription-audit-savings-starter"
ONE_SALE_PAYMENT_PACKET_ID = "OSP-20260616-25-SUBSCRIPTION-AUDIT-SAVINGS-STARTER"
ONE_SALE_PAYMENT_PACKET_INVOICE_LINE = "Subscription Audit Savings Starter fixed-scope service - $100 - accepted scope or product transfer per https://jaxassistant55.github.io/subscription-audit-savings-starter/"
PAYMENT_HANDOFF = "https://jaxassistant55.github.io/jax-micro-offer-studio/standalone-payment-handoff.html#subscription-audit-savings-starter"
...
TERMS_URL = "https://jaxassistant55.github.io/jax-micro-offer-studio/standalone-offer-terms.html#subscription-audit-savings-starter"
EXACT_ACCEPTANCE = "I accept the Subscription Audit Savings Starter fixed-scope work terms at $100. I understand work or transfer starts only after seller-owned external payment proof exists; I will provide only public or buyer-owned/buyer-authorized non-sensitive inputs; the deliverable is limited to the public preview, README/ORDER scope, and accepted ready-to-pay form details; and credentials, account login work, unauthorized private files, confidential regulated data handling, purchasing, publishing changes, ongoing support, custom implementation beyond the accepted scope, or extra revisions are not included unless separately agreed before payment."
